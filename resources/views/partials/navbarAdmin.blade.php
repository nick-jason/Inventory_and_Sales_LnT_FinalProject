        ...
        <div class="collapse navbar-collapse nav justify-content-center" id="navbarSupportedContent" style="font-weight: 300; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">
            <ul class="nav justify-content-center">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-underline">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/categories">Category List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/create-item">+ Add Item</a>
                    </li>
                    <!-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="/create-item">Add Items</a></li>
